...
> Either this or `firebaseToken` should be defined

### `firebaseToken` _{string}_

The token generated by `firebase login:ci`. Like the `firebaseServiceAccount`, this should also be stored as an [encrypted secret](https://help.github.com/en/actions/configuring-and-managing-workflows/creating-and-storing-encrypted-secrets).

> Either this or `firebaseServiceAccount` should be defined
